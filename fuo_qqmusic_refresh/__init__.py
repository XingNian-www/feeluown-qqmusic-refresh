...
def hide_unavailable_search_results() -> bool:
    return bool(_get_config_value("HideUnavailableSearchResults", True))


def set_hide_unavailable_search_results(enabled: bool) -> bool:
    if _config is None:
        return False
